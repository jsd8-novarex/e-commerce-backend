...
exports.product_list = [
    {
        ...
        description: "WRAP YOURSELF IN WARMTH WITH THE PANGAIA RECYCLED CASHMERE CARDIGAN. MADE FROM A LUXURIOUS BLEND OF RECYCLED CASHMERE, THIS CARDIGAN OFFERS SOFTNESS AND DURABLENESS IN ONE ELEGANT PIECE.",
        product_choice: [
            {
    ...
    },
    {
        ...
        description: "STEP INTO COMFORT WITH THE PANGAIA 365 HEAVYWEIGHT TRACK PANTS. MADE FROM 420 GSM HEAVYWEIGHT COTTON AND TREATED WITH PPRMNT™ FOR ANTI-ODOR PROPERTIES, HELPING KEEP YOUR TRACK PANTS FRESHER FOR LONGER, THESE TRACK PANTS BRING A WHOLE NEW LEVEL OF FRESHNESS AND SOFTNESS TO YOUR EVERYDAY WEAR.",
        product_choice: [
            {
                id: "e4d8b6c3-7f9a-4b5e-9c3d-f1e2d6a8b7c4",
                product_id: "ad599766-362e-480f-a1d6-23830980307f",
    ...
    },
    {
        ...
        description: "BRIGHTEN UP YOUR LITTLE ONE’S WARDROBE WITH THE PANGAIA KIDS 365 MIDWEIGHT T-SHIRT IN BLACK. MADE FROM 100% ORGANIC COTTON AND TREATED WITH PPRMINT™ FOR LASTING FRESHNESS, THIS T-SHIRT IS DESIGNED FOR COMFORT AND DURABILITY.",
        product_choice: [
            {
    ...
    },
    {
        ...
        description: "STEP INTO COMFORT WITH THE PANGAIA RECYCLED CASHMERE PANTS. MADE FROM A BLEND OF RECYCLED CASHMERE, THESE PANTS OFFER THE PERFECT COMBINATION OF SOFTNESS, WARMTH, AND DURABLENESS FOR LOUNGING OR CASUAL WEAR.",
        product_choice: [
            {
    ...
    },
    {
        ...
        description: "ELEVATE YOUR CASUAL WARDROBE WITH THE PANGAIA DNA POLO NECK SWEATSHIRT IN BROWN. THIS SWEATSHIRT COMBINES THE COMFORT OF A RELAXED FIT WITH THE SOPHISTICATION OF A POLO NECK, MAKING IT A VERSATILE PIECE FOR ANY OCCASION.",
        product_choice: [
            {
    ...
    },
    {
        ...
        description: "THIS PADDED OVERSHIRT IS MADE WITH FLWRFILL™, A BREAKTHROUGH WADDING CREATED USING WILDFLOWERS, LYOCELL AND A BIOPOLYMER. THE OUTER SHELL IS 100% RECYCLED NYLON. DEVELOPED IN COLLABORATION WITH IMBOTEX, FLWRFILL™ OFFERS A PLANT-BASED ALTERNATIVE TO GOOSE AND DUCK DOWN—RESULTING IN A WARM AND MORE LIGHTWEIGHT OUTERWEAR STAPLE.",
        product_choice: [
            {
